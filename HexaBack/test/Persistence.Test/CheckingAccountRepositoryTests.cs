...
public class CheckingAccountsRepositoryTests : IDisposable
{
    ...
    public CheckingAccountsRepositoryTests()
    {
        ...
        _checkingAccountsRepository = new CheckingAccountsRepository(_context);
    ...
    {
        await _checkingAccountsRepository.CreateAsync(_checkingAccount1, CancellationToken.None);
    ...
    public async Task DeleteAsync_ShouldRemoveCheckingAccount()
    {
        ...
        _checkingAccountsRepository.Delete(_checkingAccount1);
        await _context.SaveChangesAsync();
    ...
    public async Task GetAllAsync_ShouldReturnAllCheckingAccounts()
    {
        ...
        var result = _checkingAccountsRepository.GetAll();
    ...
    public async Task GetByIdAsync_ShouldReturnCheckingAccount()
    {
        ...
        var result = await _checkingAccountsRepository.GetByIdAsync(_checkingAccount1.Id, CancellationToken.None);
    ...
    public async Task Update_ShouldUpdateCheckingAccount()
    {
        ...
        _checkingAccountsRepository.Update(_checkingAccount1);
        await _context.SaveChangesAsync();
